...
if __name__ == '__main__':
    ...
    tree_err, random_err,tree_mse,random_mse = tree_and_random(train_source_data, train_labelpath_temp,test_source_data, test_labelpath_temp, test_Tipath_temp,'0')
    ...
    tree_err1, random_err1,tree_mse1,random_mse1 = tree_and_random(train_source_data, train_labelpath_temp, test_source_data,
                                           test_labelpath_temp, test_Tipath_temp, '0')

    print('test:')
    print('RT  err:' + str(0.2*tree_err + 0.8*tree_err1))
    print('RF  err:' + str(0.2*random_err + 0.8*random_err1))
    print('RT  mse:' + str(0.2 * tree_mse + 0.8 * tree_mse1))
    print('RF  mse:' + str(0.2 * random_mse + 0.8 * random_mse1))
    ...
    tree_err, random_err,tree_mse,random_mse = tree_and_random(train_source_data, train_labelpath_temp, test_source_data,
                                           test_labelpath_temp, test_Tipath_temp, '0')
    ...
    print('RF  err:' + str(0.8 * random_err + 0.2 * random_err1))
    print('RT  mse:' + str(0.8 * tree_mse + 0.2 * tree_mse1))
    print('RF  mse:' + str(0.8 * random_mse + 0.2 * random_mse1))
